...
const mechPath = fs.existsSync('./duck-mechanisms.js') ? './duck-mechanisms.js' : './duck-electric-wire/duck-mechanisms.js';
const coursePath = fs.existsSync('./duck-course.js') ? './duck-course.js' : './duck-electric-wire/duck-course.js';
const mechCode = fs.readFileSync(mechPath, 'utf8');
